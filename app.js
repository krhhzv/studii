...
const Focus = ({ setScreen, time, setTime, running, setRunning, setEndTime }) => {
    ...
    React.createElement("div",{className:"focus-body"},
      ...
      React.createElement("div",{className:`focus-circle ${running?"running":""}`},
        ...
        ? React.createElement("input",{
            ...
            onBlur:(e)=>{
              ...
              let newTime = Math.min(maxTime, Math.max(60, val * 60));
              setTime(newTime);
              if (running) setEndTime(Date.now() + newTime * 1000);
              setEditing(false);
            },
      ...
      React.createElement("div",{className:"controls"},
        React.createElement("button",{className:`btn ${running?"":"btn-primary"}`,onClick:()=>{
          if (!running) setEndTime(Date.now() + time * 1000);
...
const App = () => {
  ...
  if(screen==="focus") return React.createElement(Focus,{setScreen,time,setTime,running,setRunning,setEndTime});
  ...
  return React.createElement(
    ...
    React.createElement("div",{className:"topbar"},
      ...
      React.createElement("div",{style:{display:"flex",gap:"10px"}},
        React.createElement("div",{className:"profile-btn",onClick:()=>{
          const m = !muted;
          setMuted(m);
