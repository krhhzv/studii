...
// Home Screen
const Home = ({ setScreen, time, running, setRunning, setTime, formatTime, subjects, setSubjects, selected, setSelected, streak, dailyGoal, setDailyGoal, todayMinutes }) => {
    ...
    return React.createElement('div', { className: 'content' },
        ...
        React.createElement('div', { className: 'card' },
            ...
            React.createElement('div', { className: 'subjects' },
                subjects.map((s, i) => React.createElement('div', {
                    key: i,
                    className: `sub ${selected === s ? 'active' : ''}`,
                    onClick: () => { setSelected(s); playSound('clickSound'); },
                    onDoubleClick: () => renameSubject(s)
                }, s))
            )
        ),
...
const App = () => {
    ...
    return React.createElement('div', { className: `app screen-${screen}` },
        screen === "home" && React.createElement(Home, sharedProps),
